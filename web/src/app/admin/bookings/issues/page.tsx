...
export default function SessionIssuesPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-3xl font-bold text-gray-900">Session Issues</h1>
      ...
      <Card>
        <CardHeader>
          <h2 className="font-bold text-gray-900">Session Issues ({mockData.length})</h2>
        </CardHeader>
        <CardBody>
