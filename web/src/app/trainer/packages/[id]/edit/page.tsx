...
const MOCK_PACKAGES: Record<number, PackageFormState> = {
  ...
  3: {
    ...
    description: 'Get your CV reviewed by an industry expert with actionable feedback. We will optimize your resume for ATS, improve formatting, and enhance content to increase interview call rates.',
