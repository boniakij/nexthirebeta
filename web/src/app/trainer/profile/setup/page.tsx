...
export default function TrainerProfileSetup() {
  ...
  const [formData, setFormData] = useState<ProfileData>({
    ...
    current_designation: 'HR Lead',
    years_experience: 10,
    industry: 'Tech',
    trainer_type: 'HR Trainer',
    headline: 'Expert in HR & Recruitment',
    bio: 'I am a seasoned HR professional with over 10 years of experience in recruitment, talent management, and organizational development. Passionate about helping candidates prepare for interviews and succeed in their career goals.',
    booking_value_statement: 'Get expert guidance on interview preparation, resume building, and career advancement strategies',
    target_student_levels: ['Fresher', 'Junior'],
    preferred_session_modes: ['Video', 'Chat'],
    highest_degree: 'MBA',
