...
import { Card, CardBody, CardHeader, Badge, Button, StarRating, Skeleton, Spinner } from '@/components/ui';
import { trainerApi } from '@/lib/api/trainer';
import { Share2, MapPin, Briefcase, Star, Calendar } from 'lucide-react';
